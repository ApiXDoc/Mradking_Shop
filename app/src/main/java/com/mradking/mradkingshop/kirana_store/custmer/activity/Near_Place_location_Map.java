...
public class Near_Place_location_Map extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        get_home_location(getIntent().getExtras().getDouble("lat"),getIntent().getExtras().getDouble("log"));
        ...
        cont_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(Near_Place_location_Map.this, check_out_payment.class);
