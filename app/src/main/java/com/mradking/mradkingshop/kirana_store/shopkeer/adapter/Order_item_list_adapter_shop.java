...
public class Order_item_list_adapter_shop extends RecyclerView.Adapter<Order_item_list_adapter_shop.ViewHolder> {
    ...
    private List<cart_list_modal> pd;
    private List<cart_list_modal> productListFull;
    private RecyclerView_home_list recyclerView_home_list;

    public Order_item_list_adapter_shop(Context context, List<cart_list_modal> pd) {
    ...
    @NonNull
    @Override
    public Order_item_list_adapter_shop.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Order_item_list_adapter_shop.ViewHolder holder, int position) {
