...
public class baby_care extends Fragment implements brand_interface, product_list_interface {
...
//////////////
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","baby_care").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
