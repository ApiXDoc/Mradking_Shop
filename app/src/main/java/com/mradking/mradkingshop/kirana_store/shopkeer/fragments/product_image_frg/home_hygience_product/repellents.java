...
public class repellents extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Macher Repellent"));
        tabLayout.addTab(tabLayout.newTab().setText("Flying Kit Killer"));


        shop_list("repellents","macher_repellent");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getText().toString().contentEquals("Macher Repellent")){
                    productList.clear();
                    shop_list("repellents","macher_repellent");
                ...
                }else if(tab.getText().toString().contentEquals("Flying Kit Killer")) {

                    productList.clear();
                    shop_list("repellents", "flying_kit_killer");
                    cart_recycler_view.refreshDrawableState();
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","repellents");
...
////////////////////////
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","repellents").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
