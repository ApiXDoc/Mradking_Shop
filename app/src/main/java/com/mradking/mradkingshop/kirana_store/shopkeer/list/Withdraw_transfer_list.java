...
public class Withdraw_transfer_list extends Activity {
    private RecyclerView cart_recycler_view;
    private List<OrderListModal> productList;
    private Activity activity = Withdraw_transfer_list.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        latestGovtJobRecyclerAdapter = new WithDraw_Transfer_list_adapter( activity,productList,"transfer");
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =  firebaseFirestore.collection("kirana_order_list")
                    ...
                    .whereEqualTo("withdraw_status","no_requested")
