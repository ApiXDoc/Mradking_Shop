package com.mradking.mradkingshop.kirana_store.shopkeer.fragments.product_image_frg.home_hygience_product;
...
public class cleners extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Toilet Cleaner"));
        tabLayout.addTab(tabLayout.newTab().setText("Finial Cleaner"));
        tabLayout.addTab(tabLayout.newTab().setText("Glass Cleaner"));
        tabLayout.addTab(tabLayout.newTab().setText("Floor Cleaner"));
        tabLayout.addTab(tabLayout.newTab().setText("Bathroom Cleaner"));

        
        
        
        shop_list("cleners","toilet_cleaner");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getText().toString().contentEquals("Toilet Cleaner")){
                    productList.clear();
                    shop_list("cleners","toilet_cleaner");


                }else if(tab.getText().toString().contentEquals("Finial Cleaner")){

                    productList.clear();
                    shop_list("cleners","finial");

                }else if(tab.getText().toString().contentEquals("Glass Cleaner")){

                    productList.clear();
                    shop_list("cleners","glass_cleaner");

                }else if(tab.getText().toString().contentEquals("Bathroom Cleaner")){

                    productList.clear();
                    shop_list("cleners","bathroom_cleaner");

                }else if(tab.getText().toString().contentEquals("Floor Cleaner")){

                    productList.clear();
                    shop_list("cleners","floor_cleaner");
    ...
    private void shop_list( String text,String tab_txt) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =  firebaseFirestore.collection("Kirana_Product_Images")
                    ...
                    .whereEqualTo("sub_category_type",tab_txt)
                    .limit(10);
    ...
    private void loadMorePost(String text,String tab_txt) {
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","cleners").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
