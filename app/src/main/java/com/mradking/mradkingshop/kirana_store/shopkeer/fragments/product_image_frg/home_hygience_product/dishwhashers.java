...
public class dishwhashers extends Fragment implements brand_interface, product_list_interface {
...
////////////////
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TabLayout tabLayout=root.findViewById(R.id.tabs);
        tabLayout.addTab(tabLayout.newTab().setText("Diswash Bar"));
        tabLayout.addTab(tabLayout.newTab().setText("Diswash Zeal"));

        shop_list("dishwhashers","diswash_bar");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getText().toString().contentEquals("Diswash Bar")){
                    productList.clear();
                    shop_list("dishwhashers","diswash_bar");
                ...
                }else if(tab.getText().toString().contentEquals("Diswash Zeal")){

                    productList.clear();
                    shop_list("dishwhashers","diswash_zeal");
                    latestGovtJobRecyclerAdapter.notifyDataSetChanged();
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","dishwhashers");
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","dishwhashers").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
