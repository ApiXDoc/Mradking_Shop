...
public class air_freshners extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Bathroom Fragnace"));

        tabLayout.addTab(tabLayout.newTab().setText("Room Fragnace"));

        shop_list("air_freshners","bathroom_fragnace");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getText().toString().contentEquals("Room Fragnace")){
                    productList.clear();
                    shop_list("air_freshners","room_fragnace");
                    latestGovtJobRecyclerAdapter.notifyDataSetChanged();

                    cart_recycler_view.refreshDrawableState();


                }else if(tab.getText().toString().contentEquals("Bathroom Fragnace")){
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","air_freshners");
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","air_freshners").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
