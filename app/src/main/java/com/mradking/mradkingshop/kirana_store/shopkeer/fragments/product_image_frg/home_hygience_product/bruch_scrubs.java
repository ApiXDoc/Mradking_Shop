...
public class bruch_scrubs extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Detergents Powder"));
        tabLayout.addTab(tabLayout.newTab().setText("Detergents Bar"));
        tabLayout.addTab(tabLayout.newTab().setText("Detergents Liquid"));

        shop_list("detergents","detergents_powder");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                if(tab.getText().toString().contentEquals("Detergents Powder")){
                    productList.clear();
                    shop_list("detergents","detergents_powder");


                }else if(tab.getText().toString().contentEquals("Detergents Bar")){

                    productList.clear();
                    shop_list("detergents","detergents_bar");

                }else if(tab.getText().toString().contentEquals("Detergents Liquid")){

                    productList.clear();
                    shop_list("detergents","detergents_liquid");
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","bruch_scrubs");
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","bruch_scrubs").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
