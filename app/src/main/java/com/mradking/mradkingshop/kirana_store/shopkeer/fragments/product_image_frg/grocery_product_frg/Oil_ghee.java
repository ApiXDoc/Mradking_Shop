...
public class Oil_ghee extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Ghee"));
        tabLayout.addTab(tabLayout.newTab().setText("Refind"));
        tabLayout.addTab(tabLayout.newTab().setText("Mustard Oil"));


        shop_list("oil_ghee","Ghee");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                productList.clear();
                shop_list("oil_ghee",tab.getText().toString());
...
/////////////////////
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","oil_ghee").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
