package com.mradking.mradkingshop.kirana_store.shopkeer.fragments.product_image_frg.snacks;
...
public class chocolate extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","chocolates");
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","chocolates").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
