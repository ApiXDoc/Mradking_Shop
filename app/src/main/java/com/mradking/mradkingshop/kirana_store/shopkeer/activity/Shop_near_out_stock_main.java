...
import com.mradking.mradkingshop.kirana_store.Admin_panel.activity.shop.Shop_accepted_produdct_request_main;
...
public class Shop_near_out_stock_main extends AppCompatActivity implements brand_interface, product_list_interface {

    SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView cart_recycler_view;
    private List<AddedProductModel> productList;
    private Activity activity = Shop_near_out_stock_main.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kirana_shop_stock_main);
        ...
        toolbar.setTitle("Near To Out Of Stock");
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.navigation_1:
                        ...
                        Intent intent=new Intent(getApplicationContext(), Shop_stock_main.class);
                    ...
                    case R.id.navigation_2:
                        ...
                        Intent intent1=new Intent(getApplicationContext(), Shop_instock_main.class);
    ...
    private void shop_list() {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =  firebaseFirestore.collection("kirana_shopkeeper_product")
                   ...
                   .whereEqualTo("main_category",getIntent().getExtras().getString("key"))
