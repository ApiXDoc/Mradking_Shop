...
public class Basan_sooji_daila extends Fragment implements brand_interface, product_list_interface {
...
////////////////
        ...
        shop_list("basan_sooji_daila","Unpacked");
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                productList.clear();
                shop_list("basan_sooji_daila",tab.getText().toString());
        ...
        see_more_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("key","basan_sooji_daila");
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","basan_sooji_daila").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
