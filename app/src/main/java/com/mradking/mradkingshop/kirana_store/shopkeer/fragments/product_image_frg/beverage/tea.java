...
public class tea extends Fragment implements brand_interface, product_list_interface {
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","tea").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
