...
public class Dry_fruit extends Fragment implements brand_interface, product_list_interface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                productList.clear();
                shop_list("dry_fruit",tab.getText().toString());
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","dry_fruit").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
