...
public class Dal extends Fragment implements brand_interface, product_list_interface {
    ...
    private void shop_list( String text) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            Query firstQuery =  firebaseFirestore.collection("Kirana_Product_Images").whereEqualTo("sub_category",text).limit(10);
    ...
    private void loadMorePost(String text) {

        String uid = firebaseAuth.getCurrentUser().getUid();

        Query nextQuery =  firebaseFirestore.collection("Kirana_Product_Images").whereEqualTo("sub_category",text).startAfter(lastVisible).limit(10);
        ;
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","dal").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
