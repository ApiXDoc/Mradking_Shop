...
public class Shop_instock_main extends AppCompatActivity implements brand_interface, product_list_interface {

    SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView cart_recycler_view;
    private List<AddedProductModel> productList;
    private Activity activity = Shop_instock_main.this;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Out Of Stock Products");
