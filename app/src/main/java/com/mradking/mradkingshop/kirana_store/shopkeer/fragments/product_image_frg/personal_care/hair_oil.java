...
public class hair_oil extends Fragment implements brand_interface, product_list_interface {
    ...
    private void number_item_added_set_up() {
        ...
        firebaseFirestore.collection("kirana_shopkeeper_product")
                ...
                .collection("proudcts")
                .whereEqualTo("sub_category","hair_oil").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
